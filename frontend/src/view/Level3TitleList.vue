<template>
  <div class="TitleList">
        ...
        <a-table-column title="操作" align="center" width="240px" key="action">
          <template slot-scope="item">
            <div class="mb5">
              ...
              <a-button type="primary" size="small" @click="handleArticleClick(item.id, true)" v-if="!item.article">新建内容</a-button>
              <a-button type="primary" size="small" @click="handleArticleClick(item.id, false)" v-if="item.article">修改内容</a-button>
            </div>
            <div>
    ...
    <AddListDialog v-if="isShowAddDialog" :parentId="titleId" :id="selectedId" :isNewTitle="isAddNewTitle" @cancel="isShowAddDialog = false" @success="handleAddSuccess"></AddListDialog>
...
import AddListDialog from '@/components/Level3TitleList/AddListDialog'
